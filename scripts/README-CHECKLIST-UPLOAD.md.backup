...
Add this code to your import script (e.g., `import-donruss-soccer-2024.ts`):
...
## Example: Donruss Soccer 2024-25
...
open http://localhost:3000/releases/2024-25-panini-donruss-soccer
```
...
2. **Use descriptive names**: Use clear display names like "Panini Donruss Soccer 2024-25 Master Checklist"
