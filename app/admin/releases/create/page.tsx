                      ...
                      {imageFiles.length > 0 && (
                        <div className="mt-3 grid grid-cols-4 gap-2">
                          {imageFiles.map((file, index) => (
                            <div
                              key={index}
                              className="relative aspect-square border-2 border-purple-300 rounded-lg overflow-hidden bg-white group"
                            >
                              <img
                                ...
                                className="w-full h-full object-contain"
                              />
                              <div className="absolute bottom-0 left-0 right-0 bg-purple-900/80 text-white text-xs text-center py-1">
                                {file.name.length > 20 ? file.name.substring(0, 17) + '...' : file.name}
                              </div>
                              <button
                                onClick={() => removeImageFile(index)}
                                className="absolute top-1 right-1 bg-red-500 hover:bg-red-700 text-white rounded-full p-1 opacity-0 group-hover:opacity-100 transition-opacity"
                                title="Remove image"
                              >
