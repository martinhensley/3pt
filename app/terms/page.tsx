        ...
        <div className="bg-white border border-gray-300 rounded-lg shadow-sm p-6 md:p-10 space-y-8">
          ...
          <section className="bg-gray-100 border-2 border-gray-500 rounded-lg p-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4 text-sm">
              ...
              <li>OUR TOTAL LIABILITY TO YOU FOR ALL CLAIMS ARISING OUT OF OR RELATED TO THESE TERMS OR YOUR USE OF THE WEBSITE SHALL NOT EXCEED THE AMOUNT YOU PAID US IN THE TWELVE (12) MONTHS PRECEDING THE EVENT GIVING RISE TO LIABILITY, OR ONE HUNDRED DOLLARS ($100 USD), WHICHEVER IS LESS.</li>
