            ...
            <div className="p-8 pt-6 border-t border-white/20">
              {release.sets && release.sets.length > 0 && (
                <div className="bg-white/5 backdrop-blur-sm rounded-lg overflow-x-auto border border-white/10 max-w-full">
                  ...
                  <div className="grid grid-cols-[minmax(0,2fr)_120px_120px] gap-4 px-4 py-3 bg-white/10">
                        ...
                        {isExpanded && setsOfType.map((set: CardSet, idx: number) => {
                          ...
                          return (
                            <Link
                              key={set.id}
                              href={`/sets/${set.slug}`}
                              className={`grid grid-cols-[minmax(0,2fr)_120px_120px] gap-4 px-4 py-3 bg-gradient-to-r ${gradient} hover:from-white/20 hover:to-white/10 transition-all duration-200 border-t border-white/10 cursor-pointer`}
                            >
